    ...
    <div class="wrapper">
        <aside class="sidebar" id="sidebar">
            <div class="sidebar-logo">
                <img src="../assets/icons/logo.svg" alt="ArcGuide Logo" class="logo-full">
        ...
        <main class="content flex-grow-1" style="margin-left:260px; transition:margin-left 0.3s;">
            <div class="container-fluid py-4">
                <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap mx-5">
                    <h5 class="fw-semibold mb-0">Welcome Back Admin</h5>
                    ...
                    <?php for ($i = 0; $i < 4; $i++): ?>
                        <div class="col-md-3 col-6">
                            <div class="card shadow-sm border-0 text-center py-3">
                                <img src="../assets/icons/tourist-spot.svg" alt="Tourist Spots"
                                    style="width:40px;height:40px;margin-bottom:8px;">
                                <div class="fs-3 fw-bold">25</div>
                                <div class="text-muted">Tourists Spots</div>
                            </div>
                        </div>
                    <?php endfor; ?>
                </div>
